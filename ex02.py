...
if __name__ == "__main__":
    ...
    for vendedor in lista_vendedores:
        ...
        if 5000 <= valor_vendas < 9999.99:
            vendedor["bonus"] = 10
        elif 10000 <= valor_vendas < 14999.99:
            vendedor["bonus"] = 20
    ...
    # Distribuindo os valores adicionais aos 3 primeiros colocados em vendas
    ...
    for vendedor in lista_vendedores:
        print(f"{'Código:'.ljust(30)} {vendedor.get('codigo').ljust(40)}")
